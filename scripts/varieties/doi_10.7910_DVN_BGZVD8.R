...
"
Stay-green hybrids at Mieso 2014

Data on agronomic traits of maturity, plant height, grain yield, resistance/tolerance to biotic (insects and disease) and abiotic (drought) stress and plant aspect score collected for 29 experimental stay-green hybrids, a hybrid check evaluated at Mieso (Western Hararghe, Ethiopia) in 2014
"

	uri <- "doi:10.7910/DVN/BGZVD8"
	group <- "varieties"
	...
	f <- ff[basename(ff) == "Stay-green hybrids at Mieso 2014.xlsx"]
