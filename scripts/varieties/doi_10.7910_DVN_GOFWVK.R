...
"
Drought hybrids Mieso 2017

Data on agronomic traits of maturity, plant height, drought score, grain yield and plant aspect score collected for experimental drought tolerant hybrids evaluated at Mieso (Western Hararghe, Ethiopia) in 2017
"

	uri <- "doi:10.7910/DVN/GOFWVK"
	group <- "varieties"
	...
	f <- ff[basename(ff) == "Drought hybrids Mieso 2017.csv"]
	r <- read.csv(f)
	r <- r[r$Genotype != "", ]
