...
"
B lines observation nursery at Mieso 2014

Data on agronomic traits of maturity, plant height, grain yield, resistance/tolerance to biotic (insects and disease) and abiotic (drought) stress and plant aspect score collected for selected B lines evaluated at Mieso (Western Hararghe, Ethiopia) in 2014
"

	uri <- "doi:10.7910/DVN/SMGA6L"
	group <- "varieties"
	...
	meta <- carobiner::get_metadata(uri, path, group, major=1, minor=0,
		...
		response_vars = "yield;plant_height;flowering_days;maturity_days;spike_density",
	...
	d <- data.frame(
	  ...
	  variety_type = "B-line (hybrid parent)",
