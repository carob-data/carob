...
"
Drought hybrids Kobo 2017

Data on agronomic traits of maturity, plant height, drought score, grain yield and plant aspect score collected for experimental drought tolerant hybrids evaluated at Kobo (North Wollo, Ethiopia) in 2017
"

	uri <- "doi:10.7910/DVN/NPZJ0L"
	group <- "varieties"
