...
"
Red sorghum hybrids at Erer 2014

Data on agronomic traits of maturity, plant height, grain yield, resistance/tolerance to biotic (insects and disease) and abiotic (drought) stress and plant aspect score collected for experimental red hybrids evaluated at Erer (Sitti, Ethiopia) in 2014
"

	uri <- "doi:10.7910/DVN/6W8PGI"
	group <- "varieties"
	...
	f <- ff[basename(ff) == "Red sorghum hybrids at Erer 2014.xlsx"]
