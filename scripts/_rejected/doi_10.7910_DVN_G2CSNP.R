...
'
The title says that three sources of Phosphorus were used: Minjingu Granular, Minjingu Mazao, DAP and TSP. But the data (variable "Treatment_Fertilizer.Type") has only two types: "NAFAKA+" and "YARA" (and "Control"). 

NAFAKA+ probably has N 9%; P2O5 16%; K 6%; S 5%; CaO 25%; MgO ; Zn 0.5%; Bo 0.1%  (https://shambaza.com/listing/minjingu-nafaka-plus.html) and would be one of the Minjingu products. It is not clear which Yara product was used.

Also, the amount of fertilizer (or nutrients) applied per ha is not specified. 

The description states the data was collected from sites in Babati district though the attached data is from Kongwa and Kiteto (KK) districts; but the contact person did not work in KK and therefore cannot help
