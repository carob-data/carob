...
Soil sampling with 1x1 km grid in the agricultural area of the Axochiapan Municipality at at 0 to 30 cm depth. (2022-03-31)"
	...
	soilmeta <- data.frame(
	  variable = c("soil_P", "soil_Al", "soil_B", "soil_Ca", "soil_Fe", "soil_K", "soil_Mg", "soil_Mn", "soil_Na", "soil_S", "soil_Zn", "soil_Cu","soil_N"),
	  method = c("Bray1", "Potassium Chloride", "DTPA+Sorbitol pH 7", "Ammonium Acetate", "DTPA+Sorbitol pH 7", "Ammonium Acetate", "Ammonium Acetate", "DTPA+Sorbitol pH 7", "Ammonium Acetate", "Turbidimetric", "DTPA+Sorbitol pH 7", "DTPA+Sorbitol pH 7", "Salicylic Acid Nitration")
	)
