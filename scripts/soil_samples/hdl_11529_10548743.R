...
#  d$soil_P_method[c(38, 40)] <- "Bray1"
   ...
   soilmeta <- data.frame(
     ...
     method = c("Potassium Chloride","Ammonium Acetate","Ammonium Acetate","DTPA+Sorbitol pH 7","Ammonium Acetate","Ammonium Acetate","DTPA+Sorbitol pH 7","Ammonium Acetate","Turbidimetric","DTPA+Sorbitol pH 7","DTPA+Sorbitol pH 7","Salicylic Acid Nitration")
   )
