...
Soil sampling with 1x1 km grid in the agricultural area of the Coroneo Municipality at at 0 to 30 cm depth. (2022-04-04)
"
 
  uri <- "hdl:11529/10548665"
  group <- "soil_samples"
  ...
  f <- ff[basename(ff) == "BD_Suelo_Coroneo.xls"]
  r <- carobiner::read.excel(f, sheet ="Suelos", na=".")
  #units <- r[1,]
