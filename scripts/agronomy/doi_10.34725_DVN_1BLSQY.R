...
"
	...
	meta <- carobiner::get_metadata(uri, path, group, major=4, minor=0,
		data_organization ="WAC", #"World Agroforetry Centre; World Agroforestry Centre",
		publication = "doi:10.1016/j.jaridenv.2011.10.011",
		project = NA,
		carob_date = "2025-07-22",
		design = NA,
		data_type = "compilation",
		treatment_vars = "CA_practices",
		response_vars = "yield;fwy_total", 
		carob_contributor = "Cedric Ngakou",
		completion = 50,	
		notes = "Grain and straw data in the data table have not been processed because they are included in Rawdata, which is more complete. The same For GrainForSAS and StrawForSAS data, which are not suitable for Carob."
	)
...
geo <- data.frame(
   ...
   country= c("Senegal", "Cameroon",rep("Mali", 2), "Senegal", "Mali", rep("Burkina Faso", 3), 
              rep("Mali", 4), "Niger", "Senegal", rep("Mali", 5), "Burkina Faso", "Mali", "Niger", "Niger", "Niger", "Burkina Faso", "Burkina Faso",
              rep("Burkina Faso", 18), rep("Mali", 11), rep("Niger", 6), rep("Senegal", 3)),
