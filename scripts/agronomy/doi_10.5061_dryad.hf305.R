...
"
 ...
 d$yield <- ifelse(grepl("Mg/ha|t/ha", d$unit), d$yield*1000, 
            ifelse(grepl("t/A|t/acre", d$unit), d$yield*1000*2.471, 
            ifelse(grepl("g/m^2", d$unit), d$yield*1000, 
            ifelse(grepl("kg/m2", d$unit), d$yield*10000,
            ifelse(grepl("dt/ha", d$unit), d$yield*100,
            ifelse(grepl("kg/ square centimeter", d$unit), d$yield*10^8, 
            ...
            ifelse(grepl("lb/A", d$unit), d$yield*1.12085, d$yield))))))))))

 d  <- d[!grepl("trays/ha|lb/plant|boxes/ha|kg/plant|kg Fw/plant|kg/tree", d$unit), ]
