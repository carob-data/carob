...
## these need to be georefenced with Google Maps or similar, to the extent possible
	geo4 <- data.frame(
		...
		longitude = c( NA, NA, 7.768, NA, NA, 6.869, NA, 6.877, 6.789, NA, NA, NA, NA, 7.097, 7.121, NA, NA, NA, NA, 7.494, NA, NA, 2.916, NA, NA, NA, NA, 1.817, NA, NA, NA, 1.797, NA, 8.771, NA),
		latitude = c( NA, NA, 13.467, NA, NA, 13.653, NA, 13.538, 13.576, NA, NA, NA, NA, 13.293, 13.408, NA, NA, NA, NA, 13.81, NA, NA, 13.606, NA, NA, NA, NA, 13.1, NA, NA, NA, 13.098, NA, 13.278, NA)
	) 
