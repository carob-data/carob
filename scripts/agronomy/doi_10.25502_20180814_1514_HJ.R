...
### Dates can be used. There are some typos that can be fixed. E.g harvest dates in 2004 should be 2014
### Emergence data of 1/13/2012 is most likely be 11/30/2013 considering the values before and after it 
...
#### sub-sample weight is never processed (intermediate variable). Damage, including lodging are processed
...
#		adm2 = c("Ta Nkalo", "Ta Nkalo", "Ta Nkalo", "Ta Nkalo", "Ta Nkalo", "Ta Nkalo", "Ta Nkalo", "Ta Nkalo", "Ta Nkalo", "Ta Nthiramanja", "Ta Nkalo", "Ta Nkalo", "Ta Nkalo", "Ta Nkalo", "Ta Nkalo", "Ta Nkalo", "Ta Nthiramanja", "Ta Nthiramanja", "Ta Nthiramanja", "Ta Nthiramanja", "Ta Nthiramanja", "Ta Nthiramanja", "Sc Juma", "Sc Juma", "Ta Nthiramanja", "Ta Nthiramanja", "Ta Nthiramanja", "Ta Nthiramanja", "Sc Juma", "Ta Nthiramanja", "Sc Juma", "Sc Juma")
#	)
...
## nutrient omission rates (kg/ha), per Kihara et al. (2016); merge against a lookup table (avoids nested ifelse)
	...
	## do not drop rows just because you get a warning
	## d <- d[!is.na(d$yield), ]
