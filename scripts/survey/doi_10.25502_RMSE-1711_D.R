...
"
  ...
  d1 <- data.frame(
    ...
    year        = as.integer(r1$date_interview_yyyy), #date of interview
  ...
  d$yield[d$crop %in% c("coffee", "pumpkin")] <- d$yield[d$crop %in% c("coffee", "pumpkin")] * 1000       #pumpkin yield is 0
  d$animal[d$animal == "ducks"] <- "duck"
