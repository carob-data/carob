...
"
	...
	r2 <- haven::read_dta(paste(f2, "Data/Section B.dta", sep = "/")) |> carobiner:::unlabel()
	r3 <- haven::read_dta(paste(f2, "Data/Section E.dta", sep = "/")) |> carobiner:::unlabel()
	r4 <- haven::read_dta(paste(f2, "Data/Section G1.dta", sep = "/")) |> carobiner:::unlabel()
	r5 <- haven::read_dta(paste(f2, "Data/Section G2.dta", sep = "/")) |> carobiner:::unlabel()
	r6 <- haven::read_dta(paste(f2, "Data/Section H.dta", sep = "/")) |> carobiner:::unlabel()
