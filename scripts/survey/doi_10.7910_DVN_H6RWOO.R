...
"
	...
	#r5 <- carobiner::read.dta(f5)
	r6 <- carobiner::read.dta(f6)
	r7 <- carobiner::read.dta(f7)
	r8 <- carobiner::read.dta(f8)
	...
	#r14 <- carobiner::read.dta(f14)
	# r15 <- carobiner::read.dta(f15)
	# r16 <- carobiner::read.dta(f16)
	# r17 <- carobiner::read.dta(f17)
	# r18 <- carobiner::read.dta(f18)
	# r19 <- carobiner::read.dta(f19)
	# r20 <- carobiner::read.dta(f20)
	# r21 <- carobiner::read.dta(f21)
	# r22 <- carobiner::read.dta(f22)
	# r23 <- carobiner::read.dta(f23)
	# r24 <- carobiner::read.dta(f24)
	# r25 <- carobiner::read.dta(f25)
	# r26 <- carobiner::read.dta(f26)
	# r27 <- carobiner::read.dta(f27)
	# r28 <- carobiner::read.dta(f28)
	# r29 <- carobiner::read.dta(f29)
	# r30 <- carobiner::read.dta(f30)
	# r31 <- carobiner::read.dta(f31)
	# r32 <- carobiner::read.dta(f32)
	# r33 <- carobiner::read.dta(f33)
	# r34 <- carobiner::read.dta(f34)
	# r35 <- carobiner::read.dta(f35)
	#r36 <- carobiner::read.dta(f36)
	r37 <- carobiner::read.dta(f37)
	r38 <- carobiner::read.dta(f38)
	# r39 <- carobiner::read.dta(f39)
	# r40 <- carobiner::read.dta(f40)
	# r41 <- carobiner::read.dta(f41)
	# r42 <- carobiner::read.dta(f42)
	# r43 <- carobiner::read.dta(f43)
	# r44 <- carobiner::read.dta(f44)
	# r45 <- carobiner::read.dta(f45)
	# r46 <- carobiner::read.dta(f46)
	# r47 <- carobiner::read.dta(f47)
	# r48 <- carobiner::read.dta(f48)
	# r49 <- carobiner::read.dta(f49)
	# r50 <- carobiner::read.dta(f50)
	r51 <- carobiner::read.dta(f51)
	r52 <- carobiner::read.dta(f52)
	r53 <- carobiner::read.dta(f53)
