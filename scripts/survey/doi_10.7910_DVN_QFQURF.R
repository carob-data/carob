...
d4 <- data.frame(
 ...
 pesticide_used = grepl("yes", r6$pesticide_use),
 pesticide_product = paste(r6$pesticide1, r6$pesticide2,r6$pesticide3,r6$pesticide4, sep = ";"),
 pesticide_amount = r6$pest_kg,
 pesticide_price = r6$pesticide_value,
