...
#### Process
	...
	d2 <- data.frame(
	 ...
	 variety_trait1 = ifelse(!grepl(rejected, r2$variety1), r2$Reason1, 
	                  ifelse(grepl(rejected, r2$variety1) & grepl(rejected, r2$Rejected_variety1), r2$Reason_rej1, r2$Reason_rej2)) ,
	 variety_trait2 =  ifelse(!grepl(rejected, r2$variety2), r2$Reason1, 
	                          ifelse(grepl(rejected, r2$variety2) & grepl(rejected,  r2$Rejected_variety1), r2$Reason_rej1, r2$Reason_rej2)) ,
	 variety_trait3 =  ifelse(!grepl(rejected, r2$variety3), r2$Reason1, 
	                          ifelse(grepl(rejected, r2$variety3) & grepl(rejected,  r2$Rejected_variety1), r2$Reason_rej1, r2$Reason_rej2)) ,
